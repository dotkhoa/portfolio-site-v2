      ...
      <main className={"mx-auto w-full max-w-screen-md px-4"}>
        ...
        <div>
          ...
          <div className={"mt-2"}>
            <ul className={"list-disc pl-4 marker:text-stone-400"}>
              ...
              <li>
                Oversaw and maintain both the primary landing site and the core
                application, ensuring seamless user experiences.
              </li>
              <li>
        ...
        <div>
          ...
          <div className={"flex justify-between"}>
            ...
            <p className={"text-stone-500 dark:text-stone-300"}>2019 – 2023</p>
          </div>
          <p
            className={
